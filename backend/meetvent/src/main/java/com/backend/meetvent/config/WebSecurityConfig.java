    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .requestMatchers("/users", "/events" ,"/events/{id}", "/events/{id}/join","/users/events",
                                "/events/{id}/users", "/events/city/{name}", "/events/trending/city/{name}","/users/update", "/tinder/users", "/tinder/response/user/{id}", "/users/image", "/tinder/contacts", "/private-messages/{id}/**").authenticated()
